...
// (in-package ros_noetic_service_demo.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'ros_noetic_service_demo/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_noetic_service_demo/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ros_noetic_service_demo/AddTwoInts'; }
};
